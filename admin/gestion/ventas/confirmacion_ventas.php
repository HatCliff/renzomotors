...
$registro = "SELECT rr.*, rv.*, s.nombre_sucursal, c.*, v.nombre_modelo FROM registro_reserva rr
            ...
            WHERE compra_concretada IS NULL";
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-12">
                ...
                <a href='../ventas.php' class='btn btn-secondary' title='Volver al Panel de Ventas'> ← Volver</a>
                <a href='ventas_hechas.php' class='btn btn-info' title='Ver Ventas'>Ver Ventas</a>
                        ...
                        while ($reserva = mysqli_fetch_assoc($result_registro)) {
                            echo "
                                <tr>
                                    ...
                                    <td>
                                        <a href='accion_ventas.php?id={$reserva['id_registro_reserva']}&Accion=A' class='btn btn-success' title='Confirmar Venta'>Confirmar</a>
                                        <a href='accion_ventas.php?id={$reserva['id_registro_reserva']}&Accion=B' class='btn btn-danger' title='Cancelar Venta'>Cancelar</a>
                                    </td>
                                </tr>
                                ";
                        }
